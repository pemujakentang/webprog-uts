...
<div class="w-full h-screen overflow-scroll md:overflow-hidden md:justify-normal justify-end flex flex-col md:flex-row">
    ...
    <div class="h-full overflow-hidden flex items-end justify-center w-full md:w-[23%]">
        <div class="text-center flex flex-col md:justify-normal justify-end w-full h-screen md:h-auto">
            
            <div class="w-48 hidden md:flex mx-auto mb-5"> 
                <image class="" src="/images/pizzalogo.webp" alt=""></image>
            </div>

            <div class="h-20 md:h-24 flex flex-col justify-center w-full -rotate-[12.5deg] bg-[#ffc013] scale-[1.15] hover:scale-[1.3] duration-75 hover:font-extrabold hover:bg-[#616161] cursor-pointer mb-5" href="/"><p class="text-3xl text-white duration-75 font-bungeeregular">MENU</p></div>

            <div class="h-20 md:h-24 flex flex-col justify-center w-full -rotate-[12.5deg] bg-[#ffc013]  scale-[1.15] hover:scale-[1.3] duration-75 hover:font-extrabold hover:bg-[#616161] cursor-pointer mb-5" href="/"><p class="text-3xl text-white duration-75 font-bungeeregular">MY ORDER</p></div>

            <div class="h-20 md:h-24 flex flex-col justify-center w-full -rotate-[12.5deg] bg-[#ffc013]  scale-[1.15] hover:scale-[1.3] duration-75 hover:font-extrabold hover:bg-[#616161] cursor-pointer z-10 mb-5 md:mb-[60px] " href="/"><p class="text-3xl text-white duration-75 font-bungeeregular">CONTACT US</p></div>
            
            <div class="h-20 md:h-24 md:hidden flex flex-col justify-center w-full -rotate-[12.5deg] bg-[#ffc013]  scale-[1.15] hover:scale-[1.3] duration-75 hover:font-extrabold hover:bg-[#616161] cursor-pointer z-10 mb-[60px] md:mb-[47px] " href="/"><p class="text-3xl text-white duration-75 font-bungeeregular">SIGN IN</p></div>
