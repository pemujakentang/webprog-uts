    ...
    <div
        ...
        <div class="h-full overflow-hidden flex items-end w-full md:w-[23%] flex-col md:justify-normal justify-end">
            ...
            <div class="h-[65%] md:h-full w-full flex justify-center flex-col z-10">
                <a href="/home">
                    <div class="h-[20%] md:h-24 flex flex-col justify-center w-full -rotate-[12.5deg] bg-[#ffc013] scale-[1.15] hover:scale-[1.3] duration-75 hover:font-extrabold hover:bg-[#616161] cursor-pointer mb-6 md:mb-5"
                        href="/">
                ...
                <a href="/my-orders">
                    <div class="h-[20%] md:h-24 flex flex-col justify-center w-full -rotate-[12.5deg] bg-[#ffc013]  scale-[1.15] hover:scale-[1.3] duration-75 hover:font-extrabold hover:bg-[#616161] cursor-pointer mb-6 md:mb-5"
                        href="/">
                        <p class="text-3xl text-white duration-75 font-bungeeregular text-center">MY ORDERS</p>
                    </div>
                </a>


                <div class="h-[20%] md:h-24 flex flex-col justify-center w-full -rotate-[12.5deg] bg-[#ffc013]  scale-[1.15] hover:scale-[1.3] duration-75 hover:font-extrabold hover:bg-[#616161] cursor-pointer z-10 mb-6 md:mb-[60px] "
                    href="/">
                    <p class="text-3xl text-white duration-75 font-bungeeregular text-center">CONTACT US</p>
                </div>
