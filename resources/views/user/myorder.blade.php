                    ...
                    @foreach ($orders as $order)
                        ...
                        <div class="mt-4 mx-4 rounded-md bg-white shadow border">
                            <div class="h-8 bg-[#FFC013] rounded-t-md">
                                <!-- count order -->
                                <p class="text-black text-xl font-bebasneueregular ml-3 pt-1">ORDER #{{ $order->id }}
                                </p>
                            </div>
                            <!-- order -->
                            <div class="mb-2 flex flex-col md:flex-row">
                                ...
                                <div class="flex flex-col flex-end text-right my-4 ml-auto mr-6">
                                    <!-- total price -->
                                    <p class="text-5xl font-bebasneueregular text-black">Rp {{ $order->total_price }}
                                    </p>
                                    <!-- order status -->
                                    <p class="text-3xl font-bebasneueregular text-yellow-600">{{ $order->status }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
